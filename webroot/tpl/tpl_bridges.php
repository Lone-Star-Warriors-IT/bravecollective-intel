...
<br>
	...
	<div class="tab-pane active in" id="overview">
		...
		The <i>Lone Star Warriors Intel Map</i> provides up-to-date information on <i>PROVI</i> and known <i>hostile</i> jump bridges.
		...
		If you find any errors or have intel on hostile bridge locations, get in touch with <a href="http://evewho.com/pilot/AzAkiR+NaLDa">Azakir Nalda</a>.
	...
	<div class="tab-pane" id="dotlan">
		...
		<ol>
		    ...
		    <li>Fill in <i>PROVI</i> or <i>HOSTILE</i> as <i>Network name</i> and click <i>Create network</i></li>
		    <li>Paste the bridge list found below into <i>Network Import</i>, tick <i>Clear Bridges on Import</i> and click <i>Import</i></li>
		    <li>Go to <a href="https://evemaps.dotlan.net/bridges">https://evemaps.dotlan.net/bridges</a></li>
		    <li>Click <i>PROVI</i> or <i>HOSTILE</i> network</li>
		    <li>Click on a region, e.g. <i>Providence</i></li>
